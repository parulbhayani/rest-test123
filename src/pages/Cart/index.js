...
const CartPage = () => {
  ...
  const handleNavigate7 = () => navigate("/checkout");
      ...
      <Column className="bg-white_A700 font-poppins items-start justify-start mx-[auto] w-[100%]">
        ...
        <Column className="items-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
          <Row className="items-center justify-start 2xl:mx-[108px] 3xl:mx-[129px] mx-[144px] lg:mx-[84px] xl:mx-[96px] w-[12%]">
            ...
            <Text className="font-medium xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 text-left w-[auto]">{`Shopping Cart`}</Text>
          </Row>
        </Column>
        <Text className="font-bold lg:mt-[23px] xl:mt-[27px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[41px] mx-[auto] lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-gray_800 text-left w-[auto]">{`Shopping Cart`}</Text>
          ...
          <Row className="items-center justify-center lg:ml-[33px] xl:ml-[38px] 2xl:ml-[42px] 3xl:ml-[51px] ml-[57px] w-[40%]">
            <Row className="items-center justify-start w-[31%]">
              <Column className="border-2 border-bluegray_100 border-solid lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] items-center py-[10px] lg:py-[5px] xl:py-[6px] 2xl:py-[7px] 3xl:py-[9px] rounded-radius50 lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]">
                <Text className="font-medium mx-[auto] text-bluegray_100 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`2`}</Text>
              </Column>
              <Text className="font-medium lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] my-[10px] lg:my-[5px] xl:my-[6px] 2xl:my-[7px] 3xl:my-[9px] text-bluegray_100 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Checkout`}</Text>
            </Row>
            ...
            <Column className="w-[100%]">
              <Column className="w-[100%]">
                <Column className="w-[100%]">
                  <Row className="items-start justify-between w-[100%]">
                    <Text className="font-medium xl:mb-[2px] lg:mb-[2px] 3xl:mb-[3px] 2xl:mb-[3px] mb-[4px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Product`}</Text>
                    <Row className="items-center justify-center lg:mr-[197px] xl:mr-[225px] 2xl:mr-[253px] 3xl:mr-[304px] mr-[338px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[39%]">
                      <Text className="font-medium lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Quantity`}</Text>
                      <Text className="font-medium lg:ml-[134px] xl:ml-[154px] 2xl:ml-[173px] 3xl:ml-[208px] ml-[231px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Price`}</Text>
                      <Text className="font-medium lg:ml-[135px] xl:ml-[154px] 2xl:ml-[174px] 3xl:ml-[208px] ml-[232px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Total`}</Text>
                    </Row>
                  </Row>
                ...
                >
                  <Column className="items-center justify-start xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Row className="items-center justify-start w-[100%]">
                      ...
                      <Text className="font-medium lg:ml-[38px] xl:ml-[44px] 2xl:ml-[49px] 3xl:ml-[59px] ml-[66px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[auto]">{`Gray T-shirt`}</Text>
                      ...
                      <Text className="font-medium 2xl:ml-[104px] 3xl:ml-[125px] ml-[139px] lg:ml-[81px] xl:ml-[92px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[auto]">{`$100.99`}</Text>
                      <Text className="font-medium lg:ml-[108px] xl:ml-[124px] 2xl:ml-[139px] 3xl:ml-[167px] ml-[186px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[auto]">{`$100.99`}</Text>
                      <Image
                        src={"images/img_.svg"}
                  ...
                  <Column className="items-center justify-start xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Row className="items-center justify-start w-[100%]">
                      ...
                      <Text className="font-medium lg:ml-[38px] xl:ml-[44px] 2xl:ml-[49px] 3xl:ml-[59px] ml-[66px] lg:my-[47px] xl:my-[54px] 2xl:my-[61px] 3xl:my-[73px] my-[82px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[auto]">{`Red Flannel`}</Text>
              ...
              <Row className="items-start justify-between lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                ...
                <Column className="items-start justify-start w-[9%]">
                  <Text className="font-medium lg:ml-[56px] xl:ml-[64px] 2xl:ml-[72px] 3xl:ml-[87px] ml-[97px] lg:mr-[1px] 3xl:mr-[2px] 2xl:mr-[2px] xl:mr-[2px] mr-[3px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Total`}</Text>
                  <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                    <Text className="font-bold lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-gray_800 text-left w-[auto]">{`$202.00`}</Text>
                  </Column>
                </Column>
              </Row>
            </Column>
